           ...
           but1.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View view) {
                   ...
                   if (user.equals("") || pass.equals("")) {
                       Toast.makeText(MainActivity.this, "Username and Password Both Required !!", Toast.LENGTH_SHORT).show();
                   } else {
                       try {
                           ...
                           if(f==0)
                               Toast.makeText(MainActivity.this, "Either user not Exist or Password is incorrect !!", Toast.LENGTH_LONG).show();
